 ...
 * <a href="http://jgoodies.com/">JGoodies</a> library to add drop shadows to
 * the windows.
 *
...
public abstract class PopupWindowDecorator {
	 ...
	 * AutoComplete library. Implementations can decorate the window however they
	 * see fit.
	 *
	...
	/**
	 * Returns the singleton instance of this class. This should only be called on
	 * the EDT.
	 *
	 * @return The singleton instance of this class, or <code>null</code> for none.
	...
	/**
	 * Sets the singleton instance of this class. This should only be called on the
	 * EDT.
	 *
