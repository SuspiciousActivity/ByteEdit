...
class ParserManager implements DocumentListener, ActionListener, HyperlinkListener, PropertyChangeListener {
	 ...
	 *
	 * @param textArea
	 *            The text area whose document the parser will be
	 *            parsing.
	 */
	 ...
	 *
	 * @param delay
	 *            The delay between the last key press and when the document
	 *            is parsed.
	 * @param textArea
	 *            The text area whose document the parser will be
	 *            parsing.
	 ...
	 *
	 * @param parser
	 *            The new parser. If this is <code>null</code>, nothing
	 *            happens.
	 * @see #getParser(int)
	 ...
	 *
	 * @param millis
	 *            The new delay, in milliseconds. This must be greater
	 *            than <code>0</code>.
	 * @see #getDelay()
	 */
