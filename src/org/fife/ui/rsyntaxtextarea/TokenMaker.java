...
public interface TokenMaker {
	 ...
	 * {@link Token#NULL} if it was finished. For example, if C-style syntax
	 * highlighting is being implemented, and <code>text</code> contained a line of
	 * code that contained the beginning of a comment but no end-comment marker
	 * ("*\/"), then this method would return {@link Token#COMMENT_MULTILINE} for
	 * that line. This is useful for doing syntax highlighting.
	 *
	 ...
	 * current caret position, if it is a relevant token. If <code>null</code> is
	 * returned, a default <code>OccurrenceMarker</code> is used.
	 *
	 ...
	 * inserted after that line should be indented.
	 *
