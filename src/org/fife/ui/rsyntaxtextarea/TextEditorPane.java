...
public class TextEditorPane extends RSyntaxTextArea implements DocumentListener {
	 ...
	 *            is <code>null</code>, a file named "Untitled.txt" in the
	 *            current
	 *            directory is used.
	 * @throws IOException
	 ...
	 *            if the file is not Unicode. If this value is
	 *            <code>null</code>,
	 ...
	 *            a system default value is used.
	 * @throws IOException
	 *             If an IO error occurs reading from <code>loc</code>.
	 ...
	 * file, this method will always return <code>false</code>.
	 * <p>
	 *
	 ...
	 * @throws NullPointerException
	 *             If <code>separator</code> is
	 *             <code>null</code>.
	 * @throws IllegalArgumentException
	 *             If <code>separator</code> is not one
	 *             of "<code>\n</code>", "<code>\r\n</code>" or
	 *             "<code>\r</code>".
