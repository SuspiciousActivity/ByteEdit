...
public class TextEditorPane extends RSyntaxTextArea implements DocumentListener {
	 ...
	 *                        <code>OVERWRITE_MODE</code>.
	 * @param wordWrapEnabled Whether or not to use word wrap in this pane.
	 * @param loc             The location of the text file being edited. If this
	 *                        value is <code>null</code>, a file named
	 ...
	 * @param loc             The location of the text file being edited. If this
	 *                        value is <code>null</code>, a file named
	 *                        "Untitled.txt" in the current directory is used. This
	 *                        file is displayed as empty even if it actually exists.
	 ...
	 *                     <code>loc</code> is <code>null</code>.
	 */
	public TextEditorPane(int textMode, boolean wordWrapEnabled, FileLocation loc, String defaultEnc)
			throws IOException {
		super(textMode);
		setLineWrap(wordWrapEnabled);
		init(loc, defaultEnc);
	 ...
	 * @param defaultEnc The default encoding to use when opening the file, if the
	 *                   file is not Unicode. If this value is <code>null</code>, a
	 *                   system default value is used.
	 * @throws IOException If an IO error occurs reading from <code>loc</code>. If
	 *                     <code>loc</code> is <code>null</code>, this cannot
	 *                     happen.
	 */
	 ...
	 *
	 * @throws IOException If the file does not exist, or if an IO error occurs
	 *                     reading the file.
