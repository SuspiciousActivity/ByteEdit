 ...
 * a short period. If the current {@link TokenMaker} returns an instance of this
 * class, it is told to mark all occurrences of the identifier at the caret
 * position.
 *
...
public interface OccurrenceMarker {
	...
	/**
	 * Returns the token to mark occurrences, of, provided it matches the criteria
	 * put forth by {@link #isValidType(RSyntaxTextArea, Token)}. For most
	 * languages, this method should return the token at the caret position.
	 *
	 ...
	 * occurrences" of. Typically, this will delegate to
