...
public class WrappedSyntaxView2 {// extends CompositeView {
	...
	//
	// /**
	// * @param alloc The allocated region; this is the area inside of the
	// insets
	...
	//
	//
	// private int[] updateLayoutArray(int[] oldArray, int offset, int
	// nInserted) {
	// int n = getViewCount(); // Called after super.replace() so this is
	// accurate
