 ...
 * <code>LanguageSupport</code> implementations that may broadcast these events.
 * Note that if an RSTA/LanguageSupport does not support broadcasting these
 * events, the listener will simply never receive any notifications.
 *
...
public interface ActiveLineRangeListener extends EventListener {
	 ...
	 *
	 * @param e Information about the line range change. If there is no longer an
	 *          "active line range," the "minimum" and "maximum" line values should
	 *          both be <code>-1</code>.
	 */
