...
public interface ParameterizedCompletion extends Completion {
	...
	public static class Parameter {
		 ...
		 * Constructor.
		 *
		 * @param type The type of this parameter. This may be <code>null</code> for
		 ...
		 *
		 * @param type     The type of this parameter. This may be <code>null</code> for
		 *                 languages without specific types, dynamic typing, etc.
		 ...
		 * @param name     The name of the parameter.
		 * @param endParam Whether this parameter is an "ending parameter;" that is,
		 *                 whether this parameter is at a logical "ending point" in the
		 *                 completion text. If the user types in a parameter that is an
		 *                 ending point, parameter completion mode terminates. Set this
		 *                 to <code>true</code> for a trailing parameter after a
