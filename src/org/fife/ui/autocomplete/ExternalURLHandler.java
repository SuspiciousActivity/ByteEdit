 ...
 * browser is used to open the URL. If not running Java 6, nothing will happen.
 * If you want browser support for pre-Java 6 JRE's, you will need to register
 * one of these callbacks on your {@link AutoCompletion}, and open the URL in a
 * web browser yourself.
 * <p>
 *
...
public interface ExternalURLHandler {
	 ...
	 * @param callback Allows you to display new content in the description window.
	 */
