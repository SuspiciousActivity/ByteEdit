...
public class Util {
	 ...
	 * will attempt to use Substance cell renderers in all of our dropdowns.
	 * <p>
	 *
	 ...
	 *
	 * @param uri
	 *            The URI to open. If this is <code>null</code>, nothing
	 ...
	 *
	 * @param str
	 *            The string to check. This cannot be {@code null}.
	 * @param prefix
