...
public class ShorthandCompletion extends BasicCompletion {
	 ...
	 *                        displayed in the completion list. This may be
	 *                        <code>null</code>.
	 */
	public ShorthandCompletion(CompletionProvider provider, String inputText, String replacementText,
			String shortDesc) {
	 ...
	 *
	 * @return A description of this completion (the text that will be inserted).
	 ...
	 * summary text has been set. This is defined to return the replacement text in
	 * a monospaced font.
	 *
