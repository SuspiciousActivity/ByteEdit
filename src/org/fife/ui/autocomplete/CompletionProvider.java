...
public interface CompletionProvider {
	 ...
	 * @return The text. A return value of <code>null</code> means nothing should be
	 *         auto-completed; a value of an empty string (<code>""</code>) means
	 *         auto-completion should still be considered (i.e., all possible
	 *         choices are valid).
	 */
	 ...
	 *
	 * @param comp The text component.
	 * @return The list of {@link Completion}s. If no completions are available,
	...
	/**
	 * Returns the text that marks the end of a list of parameters to a function or
	 * method.
	 *
	 ...
	 *
	 * @return The text that separates parameters, for example, "<code>, </code>".
	 * @see #getParameterListStart()
	...
	/**
	 * Returns the text that marks the start of a list of parameters to a function
	 * or method.
	 *
	 * @return The text for a parameter list start, for example, "<code>(</code>".
	 * @see #getParameterListEnd()
	 * @see #getParameterListSeparator()
	 * @see #setParameterizedCompletionParams(char, String, char)
	 */
	 ...
	 * {@link AutoCompletion} after the user types a single character. This provider
	 * should check the text at the current caret position of the text component,
	 * and decide whether auto-activation would be appropriate here. For example, a
	 * <code>CompletionProvider</code> for Java might want to return
	 * <code>true</code> for this method only if the last character typed was a
	 * '<code>.</code>'.
	 *
	 * @param tc The text component.
	 ...
	 * functions or methods). If this method isn't called, functions and methods
	 * will not have their parameters auto-completed.
	 *
	 ...
	 *                                  <tt>listEnd</tt> is not printable ASCII, or
	 *                                  if <tt>separator</tt> is <code>null</code>
	 *                                  or an empty string.
	 ...
	 *
	 * @param parent The parent provider. <code>null</code> means there will be no
	 *               parent provider.
	 * @see #getParent()
	 */
