...
public class FoldIndicator extends AbstractGutterComponent {
	...
	protected void paintComponent(Graphics g) {
		...
		int x = width - 10;
		int line = topLine;
		boolean paintingOutlineLine = foldWithOutlineShowing != null && foldWithOutlineShowing.containsLine(line);
	...
	public void setTextArea(RTextArea textArea) {
		if (this.textArea != null) {
			this.textArea.removePropertyChangeListener(RSyntaxTextArea.CODE_FOLDING_PROPERTY, listener);
		}
