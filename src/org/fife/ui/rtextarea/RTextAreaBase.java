...
public abstract class RTextAreaBase extends JTextArea {
	...
	private boolean tabsEmulatedWithSpaces; // If true, tabs will be expanded to
											// spaces.
	private boolean highlightCurrentLine; // If true, the current line is
											// highlighted.
	private Color currentLineColor; // The color used to highlight the current
									// line.
	...
	private int marginSizeInChars; // How many 'm' widths the margin line is
									// over.
	private boolean fadeCurrentLineHighlight; // "Fade effect" for current line
												// highlight.
	...
	private BackgroundPainterStrategy backgroundPainter; // Paints the
															// background.
	 ...
	 * property change event of type {@link #BACKGROUND_IMAGE_PROPERTY}.
	 * <p>
	 *
	 * NOTE: the opaque property is set to <code>true</code> when the
	 ...
	 *
	 * @param newBackground
	 *            The <code>java.awt.Color</code> or
	 *            <code>java.awt.Image</code> object. If
	 *            <code>newBackground</code>
	 ...
	 *             If <code>line</code> isn't a valid line
	 ...
	 *         hidden (i.e. from folding).
	 * @throws BadLocationException
	 *             If <code>offs</code> isn't a valid offset
	 *             into the document.
	 */
