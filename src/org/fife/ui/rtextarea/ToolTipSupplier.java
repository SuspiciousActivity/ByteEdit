 ...
 * on its behalf. A text area will check its <tt>ToolTipSupplier</tt> for a tool
 * tip before calling the super class's implementation of
 * {@link RTextArea#getToolTipText()}. This allows applications to intercept
 * tool tip events and provide the text for a tool tip without subclassing
 * <tt>RTextArea</tt>.
 *
