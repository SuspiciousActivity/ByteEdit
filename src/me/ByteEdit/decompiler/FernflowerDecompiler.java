...
public class FernflowerDecompiler implements IBytecodeProvider, IResultSaver {
	...
	public String decompile(ClassNode cn, byte[] b, MethodNode mn) {
		try {
			...
			ContextUnit unit = new ContextUnit(ContextUnit.TYPE_FOLDER, null, fakePath, true, sc.getSaver(),
	...
	// we can ignore most of those methods because we do not want to save the output
	// as a file
	@Override
