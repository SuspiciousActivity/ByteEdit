...
public class OpcodesReverse {
	...
	public static int getHandleOpcode(String opcode) {
		switch (opcode) {
		case "getfield":
	...
	public static String reverseHandleOpcode(int opcode) {
		switch (opcode) {
	...
	public static String generateCompletionDesc(String opcode) {
		return "<html><b><u>" + opcode + "</u></b><br>" + generateDesc(opcode) + "<br><br><b>Arguments:</b><br><code>"
				+ generateByteDesc(opcode) + "</code><br><br><b>Stack:</b><br><code>" + generateStackDesc(opcode)
				+ "</code></html>";
	}
